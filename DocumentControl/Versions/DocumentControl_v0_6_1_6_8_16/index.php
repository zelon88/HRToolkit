...
<div id="button" style="float: left; ">
  <div align="center" id="loading" name="loading" style="display:none;"><img src="pacman.gif" /></div>
  ...
  <input type="submit" value="Process Pending Documents" name="ProcPending" id="button" name="submit" onclick="$('#loading').show();"/></form>
  <form action="DocCon.php#end" id="ReProcActionItems" method="post" target="DocConSum">
  <input type="submit" value="Re-Process Action Items" id="ReProcActionItems" name="ReProcActionItems" name="submit" onclick="$('#loading').show();"/></form>
  <form action="AutoBackeruper.php" id="DocConSum" method="post" target="DocConSum">
  <input type="submit" value="Backup Documents" id="button" name="submit" onclick="$('#loading').show();"/></form>
  <form action="Uploader.php" id="DocConSum" method="post" target="DocConSum">
  <input type="submit" value="Submit Documents" id="button" name="submit" onclick="$('#loading').show();"/></form>
