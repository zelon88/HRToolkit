...
// / Security Information ... 
  ...
  $URL = '';
  // / Unique Salts will increase security when running on a network. Blank salts will
   // / result in DocumentControl using a new, randomized 4 digit alpha-numeric hash daily.
  $Salt = 'testingfortruform583';
