...
function getNode($nodeToTestURL) {
  ...
  $mytmpnodeCache = '/var/www/html/HRProprietary/HRAI/Cache/nodeCacheTMP.txt';
  $mytmpnodeCachephp = '/var/www/html/HRProprietary/HRAI/Cache/nodeCacheTMP.php';
  ...
  // / If the target URL contains a nodeCache, we open it's contents and save them in our own temp location. 
    ...
    include_once '/var/www/html/HRProprietary/HRAI/Cache/nodeCacheTMP.php'; // / First we include the temp nodeCache...
    ...
    // / detected node in our local nodeCache. 
      include_once '/var/www/html/HRProprietary/HRAI/adminINFO.php';
