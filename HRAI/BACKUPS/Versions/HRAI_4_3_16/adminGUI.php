...
<div style="float: left; ">
  ...
  <iframe src="/HRProprietary/HRAI/langPar.php" name="langpar_iframer" width="300" height="350" scrolling="yes" margin-top:-4px; margin-left:-4px; border:double;></iframe>
  <form action="http://localhost/HRProprietary/HRAI/langPar.php" method="post" target="langpar_iframer">
  <input type="hidden" name="user_ID" value="<?php echo $user_ID;?>">
  <input type="hidden" name="sesID" value="<?php echo $sesID;?>">
  <input type="hidden" name="display_name" value="<?php echo $display_name;?>">
