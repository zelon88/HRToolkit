...
$display_name = defineDisplay_Name(); }
if ($user_ID !== 1) {
$display_name = get_currentuserinfo(); } }
...
if ($user_ID !== 0) {
  if (preg_match('/CMD/', $input)) {
$adminCMDfile = '/var/www/html/HRProprietary/HRAI/CoreCommands/adminCMD.php'; 
include $adminCMDfile; 
$input = preg_replace('/CMD/',' ',$input);} }
...
$CMDsyncfile = '/var/www/html/HRProprietary/HRAI/CoreCommands/CMDsync.php'; 
include $CMDsyncfile; 
...
if (preg_match('/what time/', $input)) { 
 $CMDtimefile = '/var/www/html/HRProprietary/HRAI/CoreCommands/CMDtime.php'; 
include $CMDtimefile; 
...
if (preg_match('/what is your status/', $input)) {  
 $CMDbusyfile = '/var/www/html/HRProprietary/HRAI/CoreCommands/CMDbusy.php'; 
include $CMDbusyfile; 
...
if (preg_match('/what is your uptime/', $input)) {  
 $CMDuptfile = '/var/www/html/HRProprietary/HRAI/CoreCommands/CMDuptime.php'; 
include $CMDuptfile; 
...
$CMDconvfile = '/var/www/html/HRProprietary/HRAI/CoreCommands/CMDconvert.php'; 
include $CMDconvfile; 
...
$CMDscanfile = '/var/www/html/HRProprietary/HRAI/CoreCommands/CMDscan.php'; 
include $CMDscanfile; 
