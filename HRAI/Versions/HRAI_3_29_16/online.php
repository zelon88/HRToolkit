...
if (file_exists('/var/www/html/HRProprietary/HRAI/core.php')){
    ...
    if (getServStat() == $node0ServerID.'1'.'0') {
      $node0 = '1'; } 
    elseif (getServStat() !== $node0ServerID.'1'.'0') {
      $node0 = '0'; } 
	...
	$nodeCount = $node0+$node1+$node2+$node3+$node4+$node5+$node6+$node7+$node8
...
function getNode($nodeURL){
  ...
  $nodeURL = $nodeURL1;
  $nodeURLCachefile = $nodeURL1.'/HRProprietary/HRAI/Cache/nodeCache.php';
