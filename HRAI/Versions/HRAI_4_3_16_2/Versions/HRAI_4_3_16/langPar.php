...
// / If there was no user uploaded text this var becomes 0, which tells the langPar that we want to interpret something 
...
$KillIfThereIsNoSesID = getSesIDFromCore ();
