...
if( $filename != "" ) {
  if(in_array($ext,$allowed) ) {
    ...
    rename( ("/tmp/QNTN/safedir/isolated/" . $file['file']['name'] ), ("/tmp/QNTN/safedir/isolated/" . $filename) ); } }
else {
...
<div style="max-width:400px">
<form action="/HRProprietary/scanner/scannerNOGUI.php" method="post" enctype="multipart/form-data">
