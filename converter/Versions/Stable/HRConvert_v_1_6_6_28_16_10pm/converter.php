...
elseif ( isset( $_POST['convertCloud'] ) ) {
  ...
  $logFileURL = ('http://localhost/HRProprietary/converter/Logs/') . $user_ID . $filename . $oldExtension . $extension . '.txt';
...
<br>
<div align="left">
<?php if (file_exists($logFile) && filesize($logFile) > 1 ) { ?> <ul><a href="http://localhost/HRProprietary/converter/Logs/<?php echo $logFileURL; ?>" target="_blank"><strong>INFECTED FILES DETECTED!!</strong> Click for a log of omitted files.</a></ul> <?php }; ?>
<ul><a href="<?php echo $newFileURL; ?>">Click Here to download your converted file</a></ul>
<ul><a href="http://clocalhost/cloud/temp/<?php echo $file; ?>">Click Here to download your original file</a></ul>
...
<br>
<?php } else { ?>
  <p><form action="http://localhost/HRProprietary/CloudIndexer.php">
