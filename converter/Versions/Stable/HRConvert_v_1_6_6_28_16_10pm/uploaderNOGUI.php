...
<div style="max-width:400px">
<div align="center">
<form action="http://localhost/HRProprietary/converter/converterNOGUI.php" method="post" enctype="multipart/form-data">
...
<div style="max-width:400px">
<div align="center">
<form action="/HRProprietary/converter/converterNOGUI.php" method="post" enctype="multipart/form-data">
 <select name="selected">
