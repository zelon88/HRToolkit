...
<div align="center"><img src="http://cloud.honestrepair.net/HRProprietary/converter/document.png" alt="Your Document"> </a></div>
<?php } ?>
<?php if (in_array($ext,$spreadarray) ) { ?>
<div align="center"><img src="http://cloud.honestrepair.net/HRProprietary/converter/document.png" alt="Your Document"> </a></div>
<?php } ?>
<?php if (in_array($ext,$imgarray) ) { ?>
<div align="center"><img src="http://cloud.honestrepair.net/HRProprietary/converter/document.png" alt="Your Image"> </a></div>
<?php } ?>
<?php if (in_array($ext,$audioarray) ) { ?>
<div align="center"><img src="http://cloud.honestrepair.net/HRProprietary/converter/document.png" alt="Your File"> </a></div>
<?php } ?>
...
<form action="/HRProprietary/converter/converter.php" method="post" enctype="multipart/form-data">
 <select name="selected">
  ...
  <input type="hidden" name="hiddenFile" value="<?php echo $file['file']['name']; ?>" />
  <div id="loading" style="display:none;"><img 
    src="/HRProprietary/converter/pacman.gif" /> • • • • •
